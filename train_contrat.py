...
def plot(image, ann):
    ...
    output_image_path = 'datasets/output_image.jpg'
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        for i, (imgs, targets, paths, _) in pbar:  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                remove_from_cuda(obj_feat_gt) # delet to get space
            ...
            scaler.scale(loss).backward() # sumayya you added this line
